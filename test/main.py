        ...
        for i in range(free_robot_len):
            ...
            if employ_robot != -1:
                ...
                if work_space == -1:
                    ...
                    robots[employ_robot].move_list_target0 = ask_path((workbenchs[target0].anti_x, workbenchs[target0].anti_y), robot_taking_mp[employ_robot], new_env_mp, mask_env_mp)
